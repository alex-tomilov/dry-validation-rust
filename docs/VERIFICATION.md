...
| ---------------------------------------------------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `CI`                                                       | Pull requests, pushes, manual         | Changelog gate; hosted source fallback; Ruby/Rust quality; dependency bounds; package smoke; allocation and Criterion regression checks; loading modes |
