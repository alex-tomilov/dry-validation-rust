...
- The Rust binding's Cargo configuration resolves Ruby 3.4 while the default Ruby suite uses 3.3.7; `script/verify` needs a Ruby 3.4 library path for native tests until the configurations are aligned.
